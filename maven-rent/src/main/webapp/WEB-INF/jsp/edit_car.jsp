...
<form  action="controller" method="post">
	...
	<table style="background: rgba(135, 206, 235, 0.5)">
       <tr>
            ...
            <td align="left"><input type="text" name="status" value="${car.status}" requered><br></td> 
       </tr>
       <tr> 
            <td align="right" >Цена за сут, руб:</td>
            <td align="left"> <input type="text" name="price" value="${car.price}" requered><br><br></td>
       </tr>
